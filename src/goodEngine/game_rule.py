...
class DLLGameRule(game_rule):
    ...
    def __init__(self):
        ...
        self.actionToString_low = dll._Z14actionToStringm
        ...
        self.updateState_low.argtypes = [ctypes.c_void_p, ctypes.c_uint64]
        self.updateState_low.restype = None

        self.getAction_low.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint64)]
        ...
        self.actionToString_low.argtypes = [ctypes.c_uint64]
        self.actionToString_low.restype = ctypes.c_char_p

        self.printAct_low.argtypes = [ctypes.c_uint64]
    ...
    def actionToString(self, action):
        return self.actionToString_low(ctypes.c_uint64(action)).decode('utf-8')
